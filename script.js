...
const DOM = {
    ...
    innerHTMLTransaction(transaction,index){
        ...
        `
                ...
                <td class="drescription">${transaction.description}</td>
                <td class="${CSSclass}">${amount}</td>
                <td class="date">${transaction.date}</td>
                <td><img onclick="Transaction.remove(${index})" src="./assets/minus.svg" alt="add Transações"></td>
